...
load_final_difference_cnn1d <- function(path, task_type, model_type) {
  # construct filenames
  file_name <- paste0(task_type, "_", "final_diffs", "_", model_type, ".rds")
  file_path <- file.path(path, paste0(task_type, "_CNN1D"), file_name)
  final_difference <- readRDS(file_path)

  file_name <- paste0(task_type, "_", "final_predictions", "_", model_type, ".rds")
  file_path <- file.path(path, paste0(task_type, "_CNN1D"), file_name)
  final_prediction <- readRDS(file_path)


  file_name <- paste0(task_type, "_", "final_y", "_", model_type, ".rds")
  file_path <- file.path(path, paste0(task_type, "_CNN1D"), file_name)
  final_true_value <- readRDS(file_path)
