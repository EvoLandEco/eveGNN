...
#SBATCH --job-name=gnn_bd_val_with_ddd_diffpool
#SBATCH --output=logs/gnn_bd_val_with_ddd_diffpool-%j.log
#SBATCH --mem=64GB
...
python ../Script/val_bd_with_ddd_DiffPool.py "$name" "$gnn_depth"
