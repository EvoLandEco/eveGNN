...
eve_tes_list <- replicate(5, eveGNN::edd_sim_fix_n(n = 200, pars = c(0.6, 0.1, 0, beta_phi),
                                                   age = 10,
                                                   model = "dsce2",
                                                   metric = "pd",
...
EVE_params <- data.frame(beta_n = 0, beta_phi = beta_phi,lambda = 0.6, mu = 0.1, age = 10, n = 200)
