...
bd_free_tes_list_mle <- purrr::transpose(bd_list_all$within_range)

num_elements_to_sample <- ceiling(length(bd_free_tes_list_mle) * proportion)

bd_mle_list <- sample(bd_free_tes_list_mle, num_elements_to_sample)
