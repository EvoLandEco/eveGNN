...
def main():
    ...
    path_to_gnn_model = os.path.join(name, "BD_FREE_TES", "STBO", f"BD_FREE_TES_model_diffpool_{depth}_gnn.pt")
    ...
    path_to_lstm_model = os.path.join(name, "BD_FREE_TES", "STBO", f"BD_FREE_TES_gnn_{depth}_model_lstm.pt")
    ...
    pyreadr.write_rds(os.path.join(name, "EMP_DATA", f"bd_empirical_gnn_{depth}_lstm_result.rds"),
                      emp_data_df)
