...
eve_free_tes_pd_list <- replicate(50, randomized_eve_fixed_age(dists, age = 10,
                                                                model = "dsce2",
...
eve_free_tes_ed_list <- replicate(50, randomized_eve_fixed_age(dists, age = 10,
                                                                model = "dsce2",
...
eve_free_tes_nnd_list <- replicate(50, randomized_eve_fixed_age(dists, age = 10,
                                                                 model = "dsce2",
