...
def main():
    ...
    path_to_saved_model = os.path.join(name, "DDD_FREE_TES", "DDD_FREE_TES_model_diffpool_1.pt")
    ...
    pyreadr.write_rds(os.path.join(name, "DDD_EMP_TES", "DDD_EMP_TES_predictions.rds"), final_predictions)
